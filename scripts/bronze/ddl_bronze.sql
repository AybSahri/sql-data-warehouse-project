...
Purpose:
    ...
    It drops existing versions of the tables if they already exist, then recreates 
    them with the appropriate columns and data types.

    Use this script to reset or initialize the DDL structure for the Bronze Layer.
===============================================================================
*/
